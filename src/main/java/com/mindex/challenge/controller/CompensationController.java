...
public class CompensationController {
    ...
    public Compensation read(@PathVariable String employeeId) {
        LOG.debug("Received compensation retrieve request for id [{}]", employeeId);
    ...
    public Compensation update(@PathVariable String employeeId, @RequestBody Compensation compensation) {
        LOG.debug("Received compensation update request for id [{}] with compensation [{}]", employeeId, compensation);
